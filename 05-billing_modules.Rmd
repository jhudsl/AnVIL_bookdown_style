...
You can remove the warning from this module by setting `AnVIL_module_settings$warning` to `FALSE` before running `cow::borrow_chapter`, e.g.
...
cow::borrow_chapter(
  doc_path = "child/_child_terra_billing_project_disable.Rmd",
  branch = "disable-billing-project",
  repo_name = "jhudsl/AnVIL_Template"
)
```
::::
