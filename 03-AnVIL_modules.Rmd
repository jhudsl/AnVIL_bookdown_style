...
To add a module to your book, include a code chunk with the `cow::borrow_chapter()` function, specifying the name of the module you want to borrow and the repository you want to borrow in from (the AnVIL_Template repository).
