...
To disabling a Terra Billing Project (i.e. removing the Google Billing Account that funds the Terra Billing Project):
...
1. You should see the name of the Google Billing Account that is funding this Billing Project.  Click on the teardrop icon next to the name of the Billing Account.
