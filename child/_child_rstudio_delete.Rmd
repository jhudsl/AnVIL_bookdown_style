...
1. Pausing your cloud environment only temporarily stops your work. When you are ready to delete the cloud environment, click on the RStudio icon on the righthand side and select “Settings”.

    ```{r, echo=FALSE, fig.alt='Screenshot of the Workspace page. The RStudio icon associated with the cloud environment is highlighted. The Settings button is also highlighted'}
...
1. Click on “Delete Environment”.
    ...
    ```{r, echo=FALSE, fig.alt='Screenshot of the cloud environment popout. "Delete environment" is highlighted.'}
