...
You might need to specify the path to the executable `gcloud` in the final command, e.g., `google-cloud-sdk/bin/gcloud init`.

When initiating `gcloud`, you will be asked to copy and paste a long link in your browser.
...
Select `1` to enter your Workspace's Google Project ID. You can find this by opening your Workspace and viewing the Dashboard tab. It will be something like `terra-123abcefg`.
